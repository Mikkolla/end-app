export const WorkHistory = () => {
  return (
    <>
      <section className="work-history container" data-aos="zoom-out-down">
        <h2 className="work-history__title">Work History</h2>
        <p className="work-history__desc">
        ...
        <div className="block ">
          <div className="block-first container ">
            <div className="block-first__univer">
              <h4 className="block-first__title">Lead Web Designer</h4>

              <h6 className="block-first__student">
                Student{" "}
            ...
            <div className="block-desc">
              <h4 className="block-desc__title">Certificate of web training</h4>

              <p className="block-desc__desc">
          ...
          <div className="my">
            <div className="block-first container ">
              <div className="block-first__univer">
                <h4 className="block-first__title">Junior Web Designer</h4>
              ...
              <div className="block-desc">
                <h3 className="block-desc__title">
          ...
          <div className="block-first container ">
            <div className="block-first__univer">
              <h3 className="block-first__title">Senior Web Designer</h3>
            ...
            <div className="block-desc">
              <h3 className="block-desc__title">Certificate of web training</h3>
